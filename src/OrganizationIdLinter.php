...
final class OrganizationIdLinter implements LinterInterface
{
    ...
    {
        try {
            $id = $this->organizationIdFactory->createId($input);

            return new LintPassed(
                "$input is a valid organization id number",
                sprintf(
                    "%s is a valid organization id number\n> formatted: %s\n> canonical: %s",
                    $input,
            ...
            return new LintFailed(
                "$input is not a valid organization id number",
                sprintf(
                    "Faild parsing %s as a organization id number\n%s",
                    $input,
